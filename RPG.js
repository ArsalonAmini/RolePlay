...
function displayNameSecondChallenge(){
	var name = this.name;
	document.getElementById("PrintName1").innerHTML = "Charecter Name :"+ name;
}
function displayNameThirdChallenge(){
	var name = this.name;
...
function runGame(name){
	...
	challengeThreePersonName=displayNameThirdChallenge.bind(person);
	switch(name){
		case "Alien":
